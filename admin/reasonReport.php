...
<html>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Reason Report</h4>
                    </div>
   ...
   <div class="table-responsive">
       <table id="reason" class="table table-striped table-bordered table-hover" style="width:100%">
        <thead>
            <tr>
                <th></th>
                <th>Code</th>
