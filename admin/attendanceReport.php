...
<html>
            ...
            $("#Drpt").click(function () {
                ...
                alert(code);
                      $('#attendance').DataTable({
                        ...
                        "ajax": "getAttendances.php?code=" + code,
                        "columns": [
                        {
   ...
   <div class="table-responsive">
       <table id="attendance" class="table table-striped table-bordered table-hover" style="width:100%">
        <thead>
            <tr>
                <th></th>
                <th>Date</th>
                <th>Start Time</th>
                <th>Start Meter(KM)</th>
                <th>Driver</th>
                <th>Assistant</th>
                <th>Route</th>
                <th>End Meter(KM)</th>
